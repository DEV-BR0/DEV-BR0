...
[![View Portfolio](https://img.shields.io/badge/🚀_View_My_Portfolio-6366F1?style=for-the-badge&logoColor=white&labelColor=0F0F0F)](https://dev-bro-portfolio.vercel.app/)
...
<img src="https://skillicons.dev/icons?i=html,css,js,react,nextjs,svelte,preact,vuejs,nodejs,electron,npm,webpack,vite,md,figma,tailwind,sass,git,github&theme=dark" alt="core tech stack icons"/>
...
<img src="https://skillicons.dev/icons?i=ts,redux,express,python,flask&theme=dark" alt="currently learning icons"/>
...
<img src="https://github-readme-activity-graph.vercel.app/graph?username=DEV-BR0&theme=react-dark&hide_border=true&area=true&custom_title=Contribution%20Activity" alt="animated contribution activity graph" width="100%"/>
...
A compact, always-animated line graph of your recent contribution activity — the line draws itself in with a smooth animation every time this page loads. Powered by `github-readme-activity-graph.vercel.app`, a live third-party rendering service.

**No GitHub Action or workflow required** — this pulls live data on every page view, so it's never stale and there's nothing that can fail to run. If it doesn't load, it's almost always temporary (the free-tier service is briefly rate-limited or restarting) — just wait a minute and refresh.
