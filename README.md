...
Currently building with **React** and **Next.js**, living inside the **Svelte / SvelteKit** ecosystem, and bringing every UI to life with **GSAP**.
...
<img src="https://skillicons.dev/icons?i=react,nextjs,svelte,nodejs,express,ts,js,tailwind,sass,css,gsap,git,github,vscode,figma&theme=dark" />
